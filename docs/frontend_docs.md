...
| \`--neon-y\` | \`#ffb800\` | **Warning (Amarelo):** Prioridade Média. |
...
* **Grid de Módulos:**
    * **Mercado:** Card com ícone de carrinho e **Badge Vermelho** indicando contagem de itens pendentes.
    * **Tarefas:** Card com ícone de check e **Badge Vermelho** indicando tarefas pendentes.
    * **Placeholders:** Ingredientes e Lembretes (Visualmente desabilitados/opacos).
...
* **Modal de Mercado:** Permite editar Nome e Categoria (com autocomplete inteligente).
* **Modal de Tarefas:** Permite editar:
    * **Descrição:** Texto livre.
    * **Quem fará:** Select customizado (Thiago, Débora, Casal).
    * **Prioridade:** Select customizado com indicadores visuais (🟢/🟡/🔴).
* **Estilo do Modal:** Fundo escuro (\`#121216\`), borda roxa neon, inputs flutuantes e botão de ação verde neon.
...
3.  A requisição \`fetch\` é enviada ao servidor em segundo plano.
    * *Isso garante sensação de performance nativa mesmo em conexões lentas.*
